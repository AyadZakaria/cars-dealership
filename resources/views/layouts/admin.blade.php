            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin.cars.index') }}"
                        class="flex items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.cars.*') ? 'bg-blue-100 text-blue-500 font-semibold' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-500' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}"
                        class="flex items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.users.*') ? 'bg-blue-100 text-blue-500 font-semibold' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-500' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path
                ...
                <li>
                    <a href="{{ route('admin.customers.index') }}"
                        class="flex items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.customers.*') ? 'bg-blue-100 text-blue-500 font-semibold' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-500' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path
                ...
                <li>
                    <a href="{{ route('admin.reservations.index') }}"
                        class="flex items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.reservations.*') ? 'bg-blue-100 text-blue-500 font-semibold' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-500' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path
