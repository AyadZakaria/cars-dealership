    ...
    <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="brand"
                class="w-full border px-3 py-2 rounded @error('brand') border-red-500 @enderror" value="{{ old('brand') }}"
                required>
            @error('brand')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="model"
                class="w-full border px-3 py-2 rounded @error('model') border-red-500 @enderror" value="{{ old('model') }}"
                required>
            @error('model')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        ...
        <div class="mb-4">
            ...
            <input type="number" name="year"
                class="w-full border px-3 py-2 rounded @error('year') border-red-500 @enderror" value="{{ old('year') }}"
        ...
        <div class="mb-4">
            ...
            <select name="availability"
                ...
                <option value="for_rent" {{ old('availability') == 'for_rent' ? 'selected' : '' }}>For Rent</option>
        ...
        <div class="mb-4">
            ...
            <select name="fuel_type" class="w-full border px-3 py-2 rounded @error('fuel_type') border-red-500 @enderror"
                required>
                <option value="">Select...</option>
        ...
        <div class="flex items-center ps-4 border border-gray-200 rounded-sm mb-4">
            <input type="checkbox" value="1" {{ old('in_service') ? 'checked' : '' }} name="in_service"
                id="in_service"
